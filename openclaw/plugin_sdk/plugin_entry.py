...
class OpenClawPluginApi(Protocol):
    ...
    def register_model_catalog_provider(self, provider: Mapping[str, Any]) -> None: ...

    def register_memory_embedding_provider(self, provider: Any) -> None: ...

    def register_media_understanding_provider(self, provider: Mapping[str, Any]) -> None: ...

    def register_web_search_provider(self, provider: Mapping[str, Any]) -> None: ...

    def register_video_generation_provider(self, provider: Mapping[str, Any]) -> None: ...

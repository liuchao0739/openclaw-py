...
BASE_AVAILABLE_COMMANDS: list[dict[str, Any]] = [
    {"name": "help", "description": "Show help and common commands."},
    {"name": "commands", "description": "List available commands."},
    {"name": "status", "description": "Show current status."},
    {"name": "context", "description": "Explain context usage (list|detail|json).", "input": {"hint": "list | detail | json"}},
...
_dock_commands: list[dict[str, Any]] = []


def register_dock_command(name: str, description: str) -> None:
    """Register a dock command."""
    _dock_commands.append({"name": name, "description": description})


def get_available_commands() -> list[dict[str, Any]]:
    """Return static ACP commands plus plugin-registered dock commands."""
    return [*BASE_AVAILABLE_COMMANDS, *_dock_commands]

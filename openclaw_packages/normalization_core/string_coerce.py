...
def normalize_fast_mode(raw: Any = None) -> FastMode | None:
...
def lowercase_preserving_whitespace(value: str) -> str:
    """Lowercase text while intentionally preserving surrounding whitespace."""
    return value.lower()


def locale_lowercase_preserving_whitespace(value: str) -> str:
